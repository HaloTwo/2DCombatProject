...
<details>
<summary>GIF / 영상 클립 구성 추천 펼치기/닫기</summary>

## 1. 이동과 플랫폼 액션

> 좌우 이동, 점프, 2단 점프, 대쉬, One-Way Platform 내려가기
...
> 1타 / 2타 콤보, 피격 이펙트, 데미지 텍스트, 히트스톱

| Basic Attack | Hit Feedback |
|--------------|--------------|
| <!-- TODO: GIF 추가 --> | <!-- TODO: GIF 추가 --> |
...
| Dash Attack | Ground Slam |
|-------------|-------------|
| <!-- TODO: GIF 추가 --> | <!-- TODO: GIF 추가 --> |

| Projectile Slash | Rising Slash |
|------------------|--------------|
| <!-- TODO: GIF 추가 --> | <!-- TODO: GIF 추가 --> |
...
> 정확한 타이밍의 패링과 늦은 가드의 차이를 보여주는 장면
...
> 웨이브 시작, 보스 등장, 2페이즈, 게임 클리어

| Boss Wave | Game Clear |
|-----------|------------|
| <!-- TODO: GIF 추가 --> | <!-- TODO: GIF 추가 --> |
...
| 프로젝트 | 엔진 | 장르 | 핵심 구현 | 링크 |
|----------|------|------|-----------|------|
| Crimson Slash | Unity 6 | 2D 플랫폼 액션 | Animation Event Hitbox · 4종 스킬 · 패링/가드 · Wave/Boss · Object Pool | [GitHub](https://github.com/HaloTwo/2DCombatProject) / <!-- TODO: [영상](영상링크) --> |

## 🔹 Crimson Slash (Unity 6, 2D Action)

> Unity 6 기반 PC/Steam 대응 2D 플랫폼 액션 전투 프로토타입입니다.  
...
```text
00:00 Start / Loading
00:05 Movement & Platform
00:15 Basic Attack Combo
00:30 Skills
00:55 Parry / Guard / Projectile Reflect
01:10 Breakable Object & Buff Item
01:25 Focus Mode
01:45 Boss Wave
02:10 Game Clear
02:20 Code Structure Summary
```

마지막 5~10초는 Unity 플레이 화면 대신  
`Hitbox`, `Hurtbox`, `PlayerSkillController`, `EnemyBrainBase`, `ObjectPool`, `SoundManager` 구조를 보여주면 좋습니다.
