...
> 2D 액션 로그라이트 장르의 전투 흐름을 모티브로 제작한  
> Unity 6 기반 전투 프로토타입입니다.

> 입력, 애니메이션 이벤트 기반 판정, 피격 피드백, 스킬, 웨이브, 미니보스,  
> 버프 아이템, 오브젝트 풀링을 중심으로 짧은 플레이 안에서 액션 전투 루프가 보이도록 구현했습니다.
...
[![영상 미리보기](https://img.youtube.com/vi/WMT9xRD1Y8A/maxresdefault.jpg)](https://youtu.be/WMT9xRD1Y8A)
